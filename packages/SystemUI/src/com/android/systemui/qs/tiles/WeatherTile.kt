...
class WeatherTile @Inject constructor(
    ...
    qsLogger: QSLogger
) : QSTileImpl<BooleanState>(host, uiEventLogger, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, mActivityStarter, qsLogger),
    ...
    override fun handleClick(@Nullable view: View?) {
        ...
        if (!mState.value || mWeatherData == null) {
            ...
            for (app in ALTERNATIVE_WEATHER_APPS) {
                if (systemUtils.isPackageInstalled(mContext, app)) {
            ...
            if (systemUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
